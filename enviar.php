...
if((isset($_POST['email']) && !empty(trim($_POST['email']))) && (isset($_POST['mensagem']) && !empty(trim($_POST['mensagem'])))) {
	...
	$mail->SMTPAuth = true;
	$mail->Username = 'gabrielnoronha.developer@gmail.com';
	$mail->Password = 'jabutilovers';
	$mail->Port = 587;
 
	$mail->setFrom('gabrielnoronha.developer@gmail.com');
	$mail->addAddress('gabrielnoronha.developer@gmail.com');
